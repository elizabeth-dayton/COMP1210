 ...
 *SpherocylinderList2 constructor.
   ...
   *@param listIn used.
   *@param numberOfSpherocylindersIn used.
   */
 ...
 */
   ...
   */
   public SpherocylinderList2 readFile(String fileNameIn) 
      ...
      SpherocylinderList2 mySpherocylinderList 
         = new SpherocylinderList2(sListName, myList, numberOfSpherocylinders);
   ...
   */
   public Spherocylinder findSpherocylinderWithShortestRadius() {
      ...
      Spherocylinder shortestRadius = spheroList[0];
      int index = 0;
      while (index < numberOfSpherocylinders) {
         if (!(shortestRadius.getRadius() < spheroList[index].getRadius())) {
            shortestRadius = spheroList[index];
         }
         index++;  
      }   
   ...
   */
   public Spherocylinder findSpherocylinderWithLongestRadius() {
      ...
      Spherocylinder longestRadius = spheroList[0];
      int index = 0;
      while (index < numberOfSpherocylinders) {
         if (longestRadius.getRadius() < spheroList[index].getRadius()) {
            longestRadius = spheroList[index];
         }
         index++;  
      }   
   ...
   */
   public Spherocylinder findSpherocylinderWithSmallestVolume() {
      ...
      Spherocylinder smallestVolume = spheroList[0];
      int index = 0;
      while (index < numberOfSpherocylinders) {
         if (!(smallestVolume.volume() < spheroList[index].volume())) {
            smallestVolume = spheroList[index];
         }
         index++;  
      }   
...
*/
   public Spherocylinder findSpherocylinderWithLargestVolume() {
      ...
      Spherocylinder largestVolume = spheroList[0];
      int index = 0;
      while (index < numberOfSpherocylinders) {
         if (largestVolume.volume() < spheroList[index].volume()) {
            largestVolume = spheroList[index];
         }
         index++;  
      }   
